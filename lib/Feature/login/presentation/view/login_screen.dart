...
import 'package:marketi_ecommers/Feature/login/presentation/view_models/user_cubit/user_cubit.dart';
import 'package:marketi_ecommers/Feature/login/presentation/view_models/user_cubit/user_state.dart';
        ...
        if (State is SignInSuccess) {
          ScaffoldMessenger.of(context).showSnackBar(
             SnackBar(
              ...
              content: Center(
                  child: Text(loginScreenModel.successfulluSnackBar)),
            ),
          );
