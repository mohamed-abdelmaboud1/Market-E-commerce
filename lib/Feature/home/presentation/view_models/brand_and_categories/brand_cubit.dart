...
class BrandCubit extends Cubit<BrandAndCategoryState> {
  BrandCubit(this.apiConsumer) : super(BrandAndCategoryInitial());
  ...
  Future<void> fetchProducts() async {
    ...
    try {
      ...
      emit(BrandAndCategoryError('Failed to load brands'));
    }
  }
}
